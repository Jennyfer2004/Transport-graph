...
def main():
    ...
    st.write("Si deseas interactuar con una red de transporte y adaptarla a tus propias ideas, en el panel de la izquiera selecciona la opción de \"Red Interactiva\" y te encuentrarás frente a un mapa vibrante que parece cobrar vida. Las líneas que se entrelazan son más que simples rutas; son los hilos invisibles que tejen nuestra sociedad. Cada nodo en este entramado es una puerta abierta a nuevas experiencias.")
